...
SECRET_KEY = os.environ.get('SECRET_KEY', '+n=pp(r!lwac88zd2p^z8aw5n$qq9zv8n+%8h%-iw#&ves-q3c')
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "merofirstproject/static_in_env", "media_root")
